...
Copyright
    ...
    gen_clib_pro is distributed in the hope that it will be useful, but
...
project: str = 'gen_clib_pro'
project_copyright: str = '2026, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '4.0'
release: str = 'https://github.com/vroncevic/gen_clib_pro/releases'
...
htmlhelp_basename: str = 'gen_clib_prodoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_clib_pro.tex', 'gen_clib_pro Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_clib_pro', 'gen_clib_pro Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_clib_pro', 'gen_clib_pro Documentation', author,
    'gen_clib_pro', 'One line description of project.', 'Miscellaneous'
)]
