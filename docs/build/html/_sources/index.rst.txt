...
.. |Debian Linux OS| image:: https://raw.githubusercontent.com/vroncevic/gen_clib_pro/dev/docs/debtux.png
...
.. code-block:: bash
   ...
   cd gen_clib_pro-4.0
   sudo cp -R ~/sh_tool/bin/   /root/scripts/gen_clib_pro/ver.x.y/
   sudo cp -R ~/sh_tool/conf/  /root/scripts/gen_clib_pro/ver.x.y/
   sudo cp -R ~/sh_tool/log/   /root/scripts/gen_clib_pro/ver.x.y/

Or You can use Docker to create image/container.

|GitHub docker checker|

.. |GitHub docker checker| image:: https://github.com/vroncevic/gen_clib_pro/workflows/gen_clib_pro%20docker%20checker/badge.svg
   :target: https://github.com/vroncevic/gen_clib_pro/actions?query=workflow%3A%22gen_clib_pro+docker+checker%22
...
Copyright (C) 2017 - 2026 by `vroncevic.github.io/gen_clib_pro <https://vroncevic.github.io/gen_clib_pro>`_
...
.. |Free Software Foundation| image:: https://raw.githubusercontent.com/vroncevic/gen_clib_pro/dev/docs/fsf-logo_1.png
